...
; - MoveSoundTable (see data/moves/sfx.asm)
	...
	const LEAF_BLADE   ; b2
	const IRON_HEAD    ; b3
	const SHADOW_CLAW  ; b4
	const FLASH_CANNON ; b5
	const AURA_SPHERE  ; b6
	const DRAIN_PUNCH  ; b7
	const AIR_SLASH    ; b8
	const EARTH_POWER  ; b9
	const POISON_JAB   ; ba
	const POWER_GEM    ; bb
	const BUG_BUZZ     ; bc
	const ROCK_WRECKER ; bd
	const DARK_PULSE   ; be
	const DRAGON_PULSE ; bf
	const FAIRY_WIND   ; c0
	const MOONBLAST    ; c1
	const PLAY_ROUGH   ; c2
	;const SHADOW_BONE  ; c3
	const PLASMA_FISTS ; c3
	const THUNDEROUS_KICK ; c4
	;const SUPER_LICK   ; c5
	; end of added moves
