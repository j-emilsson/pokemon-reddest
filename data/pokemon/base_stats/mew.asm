	...
	tmhm MEGA_PUNCH,   RAZOR_WIND,   SWORDS_DANCE, WHIRLWIND,    MEGA_KICK,    \
	     ...
	     SLUDGE_BOMB,  OUTRAGE,      DRAGON_BREATH,SHADOW_BALL,  CRUNCH,       \
		 GIGA_DRAIN,   HYPER_VOICE,  LEAF_BLADE,   IRON_HEAD,    FLASH_CANNON, \
		 AURA_SPHERE,  DRAIN_PUNCH,  AIR_SLASH,    EARTH_POWER,  POISON_JAB,   \
		 POWER_GEM,    BUG_BUZZ,     DARK_PULSE,   DRAGON_PULSE, PLAY_ROUGH,   \
