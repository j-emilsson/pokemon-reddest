...
Green1Data:
	...
	db 5, JOLTEON, 0
; Route 22
	db $FF, 10, SHELLDER, 12, FLAREON, 0
	db $FF, 10, EXEGGCUTE, 12, VAPOREON, 0
	db $FF, 10, RHYHORN, 12, JOLTEON, 0
; Cerulean City
	db $FF, 17, PIKACHU, 18, FARFETCHD, 18, SHELLDER, 20, FLAREON, 0
	db $FF, 17, PIKACHU, 18, FARFETCHD, 18, EXEGGCUTE, 20, VAPOREON, 0
	db $FF, 17, PIKACHU, 18, FARFETCHD, 18, RHYHORN, 20, JOLTEON, 0

Green2Data:
; SS Anne 2F
	db $FF, 24, PIKACHU, 25, FARFETCHD, 25, SHELLDER, 27, FLAREON, 0
	db $FF, 24, PIKACHU, 25, FARFETCHD, 25, EXEGGCUTE, 27, VAPOREON, 0
	db $FF, 24, PIKACHU, 25, FARFETCHD, 25, RHYHORN, 27, JOLTEON, 0
; Pokémon Tower 2F
	db $FF, 32, PIKACHU, 33, GYARADOS, 33, FARFETCHD, 33, SHELLDER, 35, FLAREON, 0
	db $FF, 32, PIKACHU, 33, GYARADOS, 33, FARFETCHD, 33, EXEGGCUTE, 35, VAPOREON, 0
	db $FF, 32, PIKACHU, 33, GYARADOS, 33, FARFETCHD, 33, RHYHORN, 35, JOLTEON, 0
; Silph Co. 7F
	db $FF, 45, RAICHU, 46, GYARADOS, 46, FARFETCHD, 46, CLOYSTER, 48, FLAREON, 0
	db $FF, 45, RAICHU, 46, GYARADOS, 46, FARFETCHD, 46, EXEGGUTOR, 48, VAPOREON, 0
	db $FF, 45, RAICHU, 46, GYARADOS, 46, FARFETCHD, 46, RHYDON, 48, JOLTEON, 0
; Route 22
	db $FF, 55, RAICHU, 56, JYNX, 56, GYARADOS, 56, FARFETCHD, 56, CLOYSTER, 58, FLAREON, 0
	db $FF, 55, RAICHU, 56, JYNX, 56, GYARADOS, 56, FARFETCHD, 56, EXEGGUTOR, 58, VAPOREON, 0
	db $FF, 55, RAICHU, 56, JYNX, 56, GYARADOS, 56, FARFETCHD, 56, RHYDON, 58, JOLTEON, 0

ProfOakData:
; Unused
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 70, GYARADOS, 75, FLAREON, 0
...
LoreleiData:
	db $FF, 65, TENTACRUEL, 65, MAGMAR, 65, STARMIE, 65, NIDOQUEEN, 67, BLASTOISE, 70, LAPRAS, 0
	
BrunoData:
	db $FF, 66, HITMONCHAN, 66, ELECTABUZZ, 66, HITMONLEE, 66, PINSIR, 68, ONIX, 71, MACHAMP, 0

AgathaData:
	db $FF, 67, ARBOK, 67, JYNX, 67, GOLBAT, 67, MAROWAK, 69, VENUSAUR, 72, GENGAR, 0

LanceData:
	db $FF, 68, GYARADOS, 68, PRIMEAPE, 68, AERODACTYL, 68, NIDOKING, 70, CHARIZARD, 73, DRAGONITE, 0
