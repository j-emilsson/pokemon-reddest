TypeEffects:
	...
	db ICE,          FIRE,         NOT_VERY_EFFECTIVE ; added to be updated to gen 2+
	...
	;db POISON,       BUG,          SUPER_EFFECTIVE ; removed to be updated to gen 2+
	...
	db BUG,          POISON,       NOT_VERY_EFFECTIVE ; changed to be updated to gen 2+
	...
	db GHOST,        PSYCHIC,      SUPER_EFFECTIVE ; changed to be updated to gen 2+
	...
	db DARK,		 GHOST,		   SUPER_EFFECTIVE ; new dark type start
	...
	db PSYCHIC,      DARK,		   NO_EFFECT ; new dark type stop
	db STEEL,		 ICE,		   SUPER_EFFECTIVE ; new steel type start
	...
	db POISON,		 STEEL,		   NO_EFFECT ; new steel type stop
	db FAIRY,		 DARK,		   SUPER_EFFECTIVE ; new fairy type start
	...
	db STEEL,		 FAIRY,		   SUPER_EFFECTIVE
	db DRAGON,		 FAIRY,		   NO_EFFECT ; new fairy type stop
	db -1 ; end
