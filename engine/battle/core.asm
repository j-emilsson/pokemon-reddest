...
HandlePoisonBurnLeechSeed_DecreaseOwnHP:
	...
	srl b
	rr c
	;srl c ; comment out this line to make the damage 1/8 of max HP instead of 1/16
...
; was congruent to 0 modulo 256.
	...
	ld [wPlayerBideAccumulatedDamage + 1], a ; fixes the bug
...
DrawPlayerHUDAndHPBar:
	...
	call CenterMonName
	call PlaceString
	callfar PrintEXPBar ; adds EXP bar to player HUD
...
.allMovesChecked
	;and a ; any PP left?
	and $3f ; taking PP Ups into account
