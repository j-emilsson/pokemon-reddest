...
INCLUDE "data/maps/headers/MoveTutorsHouse.asm"
INCLUDE "scripts/MoveTutorsHouse.asm"
INCLUDE "data/maps/objects/MoveTutorsHouse.asm"
MoveTutorsHouse_Blocks: INCBIN "maps/MoveTutorsHouse.blk"